...
```
 # ros2_dashing_openvino_202104_v1.tar for demo
 cd ~/Downloads/
 weget https://github.com/intel/ros2_openvino_toolkit/tree/master/DockerImages/ros2_dashing_openvino_202104_v1.tar
```
* Load docker image
```
cd ~/Downloads/
docker load -i ros2_dashing_openvino_202104_v1.tar
docker Images
/// (show ros2_dashing_openvino_202104_v1 images in list)
```
