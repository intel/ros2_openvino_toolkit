...
TEST(UnitTestFaceDetection, testEmotionDetection)
{
  ...
  auto openvino_emotionRecognition_callback =
    [&sub_called](const vino_people_msgs::msg::EmotionsStamped::SharedPtr msg) -> void {
  ...
  {
    auto sub2 = node->create_subscription<vino_people_msgs::msg::EmotionsStamped>(
...
TEST(UnitTestFaceDetection, testageGenderDetection)
{
  ...
  auto openvino_ageGender_callback =
    [&sub_called](const vino_people_msgs::msg::AgeGenderStamped::SharedPtr msg) -> void {
  ...
  {
    auto sub3 = node->create_subscription<vino_people_msgs::msg::AgeGenderStamped>(
...
TEST(UnitTestFaceDetection, testheadPoseDetection)
{
  ...
  auto openvino_headPose_callback =
    [&sub_called](const vino_people_msgs::msg::HeadPoseStamped::SharedPtr msg) -> void {
  ...
  {
    auto sub4 = node->create_subscription<vino_people_msgs::msg::HeadPoseStamped>(
...
int main(int argc, char * argv[])
{
  ...
  system("ros2 launch vino_test pipeline_image_test.launch.py &");
