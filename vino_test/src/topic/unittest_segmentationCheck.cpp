...
#include <vino_people_msgs/msg/objects_in_masks.hpp>
...
TEST(UnitTestObjectDetection, testObjectDetection)
{
  ...
  auto openvino_faceDetection_callback =
    [&sub_called](const vino_people_msgs::msg::ObjectsInMasks::SharedPtr msg) -> void {
      test_pass = true;
  ...
  {
    auto sub1 = node->create_subscription<vino_people_msgs::msg::ObjectsInMasks>(
...
int main(int argc, char * argv[])
{
  ...
  system("ros2 launch vino_test pipeline_segmentation_test.launch.py &");
