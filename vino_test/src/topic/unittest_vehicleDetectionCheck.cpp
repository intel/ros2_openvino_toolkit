...
#include <vino_people_msgs/msg/vehicle_attribs.hpp>
#include <vino_people_msgs/msg/vehicle_attribs_stamped.hpp>
#include <vino_people_msgs/msg/license_plate.hpp>
#include <vino_people_msgs/msg/license_plate_stamped.hpp>
...
{
  auto node = rclcpp::Node::make_shared("openvino_vehicle_test");
  ...
  auto openvino_vehicle_callback =
    [&sub_called](const vino_people_msgs::msg::LicensePlateStamped::SharedPtr msg) -> void {
      test_pass = true;
  ...
  {
    auto sub1 = node->create_subscription<vino_people_msgs::msg::LicensePlateStamped>(
...
int main(int argc, char * argv[])
{
  ...
  system("ros2 launch vino_test pipeline_vehicle_detection_test.launch.py &");
