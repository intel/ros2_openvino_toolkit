...
vino_core_lib::LandmarksDetectionResult::LandmarksDetectionResult(
  const cv::Rect & location)
: Result(location) {}

// LandmarksDetection
vino_core_lib::LandmarksDetection::LandmarksDetection()
: vino_core_lib::BaseInference() {}

vino_core_lib::LandmarksDetection::~LandmarksDetection() = default;
void vino_core_lib::LandmarksDetection::loadNetwork(
...
bool vino_core_lib::LandmarksDetection::enqueue(
...
vino_core_lib::LandmarksDetection::getLocationResult(int idx) const
{
  return &(results_[idx]);
}
...
void vino_core_lib::LandmarksDetection::observeOutput(
...
const std::vector<cv::Rect> vino_core_lib::LandmarksDetection::getFilteredROIs(
