...
// EmotionsResult
vino_core_lib::EmotionsResult::EmotionsResult(const cv::Rect & location)
: Result(location)
{
}

// Emotions Detection
vino_core_lib::EmotionsDetection::EmotionsDetection()
...
void vino_core_lib::EmotionsDetection::loadNetwork(
...
bool vino_core_lib::EmotionsDetection::enqueue(
  const cv::Mat & frame,
...
vino_core_lib::EmotionsDetection::getLocationResult(int idx) const
{
  return &(results_[idx]);
}
...
void vino_core_lib::EmotionsDetection::observeOutput(
...
const std::vector<cv::Rect> vino_core_lib::EmotionsDetection::getFilteredROIs(
