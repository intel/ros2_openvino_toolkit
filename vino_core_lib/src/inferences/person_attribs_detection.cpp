...
vino_core_lib::PersonAttribsDetectionResult::PersonAttribsDetectionResult(
...
bool vino_core_lib::PersonAttribsDetection::enqueue(
...
vino_core_lib::PersonAttribsDetection::getLocationResult(int idx) const
{
  return &(results_[idx]);
}
...
void vino_core_lib::PersonAttribsDetection::observeOutput(
...
const std::vector<cv::Rect> vino_core_lib::PersonAttribsDetection::getFilteredROIs(
