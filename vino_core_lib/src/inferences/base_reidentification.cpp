...
#include <string>
#include <functional>
#include "vino_core_lib/inferences/base_reidentification.hpp"
#include "vino_core_lib/slog.hpp"

// Tracker
vino_core_lib::Tracker::Tracker(
...
double vino_core_lib::Tracker::findMostSimilarTrack(
...
double vino_core_lib::Tracker::calcSimilarity(
...
void vino_core_lib::Tracker::updateMatchTrack(
