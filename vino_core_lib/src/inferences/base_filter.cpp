...
#include "vino_core_lib/inferences/base_filter.hpp"
#include <stack>
#include <string>
#include <vector>
...
bool vino_core_lib::BaseFilter::isValidFilterConditions(
  const std::string & filter_conditions)
{
  return strip(filter_conditions) != "";
}

void vino_core_lib::BaseFilter::acceptFilterConditions(
  const std::string & filter_conditions)
{
...
bool vino_core_lib::BaseFilter::isPriorTo(
...
vino_core_lib::BaseFilter::getSuffixConditions() const
{
  return suffix_conditons_;
}

bool vino_core_lib::BaseFilter::logicOperation(
...
bool vino_core_lib::BaseFilter::stringCompare(
...
bool vino_core_lib::BaseFilter::floatCompare(
...
std::vector<std::string> vino_core_lib::BaseFilter::split(
  const std::string & filter_conditions)
{
...
void vino_core_lib::BaseFilter::infixToSuffix(
  std::vector<std::string> & infix_conditions)
{
