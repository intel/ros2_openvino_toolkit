...
vino_core_lib::VehicleAttribsDetectionResult::VehicleAttribsDetectionResult(
  const cv::Rect & location)
: Result(location) {}

// VehicleAttribsDetection
vino_core_lib::VehicleAttribsDetection::VehicleAttribsDetection()
...
bool vino_core_lib::VehicleAttribsDetection::enqueue(
...
vino_core_lib::VehicleAttribsDetection::getLocationResult(int idx) const
{
  return &(results_[idx]);
}
...
void vino_core_lib::VehicleAttribsDetection::observeOutput(
...
const std::vector<cv::Rect> vino_core_lib::VehicleAttribsDetection::getFilteredROIs(
