...
#if 0
#include "vino_core_lib/inferences/landmarks_detection.hpp"
#include "vino_core_lib/inferences/face_reidentification.hpp"
#include "vino_core_lib/models/face_reidentification_model.hpp"
#include "vino_core_lib/models/landmarks_detection_model.hpp"
#endif

#include "vino_core_lib/models/vehicle_attribs_detection_model.hpp"
#include "vino_core_lib/models/license_plate_detection_model.hpp"
#include "vino_core_lib/models/person_reidentification_model.hpp"
#include "vino_core_lib/models/person_attribs_detection_model.hpp"
#include "vino_core_lib/inferences/vehicle_attribs_detection.hpp"
#include "vino_core_lib/inferences/license_plate_detection.hpp"
#include "vino_core_lib/inferences/person_reidentification.hpp"
#include "vino_core_lib/inferences/person_attribs_detection.hpp"
#include "vino_core_lib/inferences/face_detection.hpp"
#include "vino_core_lib/models/face_detection_model.hpp"
#include "vino_core_lib/inferences/age_gender_detection.hpp"
#include "vino_core_lib/models/age_gender_detection_model.hpp"
#include "vino_core_lib/inferences/emotions_detection.hpp"
#include "vino_core_lib/models/emotion_detection_model.hpp"
#include "vino_core_lib/inferences/head_pose_detection.hpp"
#include "vino_core_lib/models/head_pose_detection_model.hpp"
#include "vino_core_lib/models/object_detection_yolov2_model.hpp"
#include "vino_core_lib/models/object_detection_ssd_model.hpp"
#include "vino_core_lib/inferences/object_segmentation.hpp"
#include "vino_core_lib/models/object_segmentation_model.hpp"
#include "vino_core_lib/inputs/base_input.hpp"
#include "vino_core_lib/inputs/image_input.hpp"
#include "vino_core_lib/inputs/realsense_camera.hpp"
#include "vino_core_lib/inputs/realsense_camera_topic.hpp"
#include "vino_core_lib/inputs/standard_camera.hpp"
#include "vino_core_lib/inputs/ip_camera.hpp"
#include "vino_core_lib/inputs/video_input.hpp"
#include "vino_core_lib/outputs/image_window_output.hpp"
#include "vino_core_lib/outputs/ros_topic_output.hpp"
#include "vino_core_lib/outputs/rviz_output.hpp"
#include "vino_core_lib/outputs/ros_service_output.hpp"
#include "vino_core_lib/pipeline.hpp"
#include "vino_core_lib/pipeline_manager.hpp"
#include "vino_core_lib/pipeline_params.hpp"
#include "vino_core_lib/services/pipeline_processing_server.hpp"
#include "vino_core_lib/engines/engine_manager.hpp"
...
PipelineManager::createObjectSegmentation(const Params::ParamManager::InferenceRawData & infer)
{
  ...
  auto segmentation_inference_ptr = std::make_shared<vino_core_lib::ObjectSegmentation>(
  ...
  const Params::ParamManager::InferenceRawData & infer)
{
  ...
  auto vehicle_attribs_ptr =
    std::make_shared<vino_core_lib::VehicleAttribsDetection>();
  ...
  const Params::ParamManager::InferenceRawData & infer)
{
  ...
  auto license_plate_ptr =
    std::make_shared<vino_core_lib::LicensePlateDetection>();
  ...
  const Params::ParamManager::InferenceRawData & infer)
{
  ...
  auto attribs_inference_ptr =
    std::make_shared<vino_core_lib::PersonAttribsDetection>(infer.confidence_threshold);
  ...
  const Params::ParamManager::InferenceRawData & infer)
{
  ...
  auto landmarks_inference_ptr =
    std::make_shared<vino_core_lib::LandmarksDetection>();
  ...
  const Params::ParamManager::InferenceRawData & infer)
{
  ...
  auto engine = engine_manager_.createEngine(infer.engine, model);
  auto face_reid_ptr =
    std::make_shared<vino_core_lib::FaceReidentification>(infer.confidence_threshold);
...
void PipelineManager::runService()
{
  auto node = std::make_shared<vino_service::PipelineProcessingServer
      <vino_pipeline_srv_msgs::srv::PipelineSrv>>("pipeline_service");
