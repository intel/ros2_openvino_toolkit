 ...
 */
#ifndef VINO_CORE_LIB__INFERENCES__VEHICLE_ATTRIBS_DETECTION_HPP_
#define VINO_CORE_LIB__INFERENCES__VEHICLE_ATTRIBS_DETECTION_HPP_
...
#endif  // VINO_CORE_LIB__INFERENCES__VEHICLE_ATTRIBS_DETECTION_HPP_
