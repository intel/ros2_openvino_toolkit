 ...
 */
#ifndef VINO_CORE_LIB__INFERENCES__PERSON_REIDENTIFICATION_HPP_
#define VINO_CORE_LIB__INFERENCES__PERSON_REIDENTIFICATION_HPP_
...
private:
  ...
  std::shared_ptr<vino_core_lib::Tracker> person_tracker_;
};
}  // namespace vino_core_lib
#endif  // VINO_CORE_LIB__INFERENCES__PERSON_REIDENTIFICATION_HPP_
