 ...
 */
#ifndef VINO_CORE_LIB__INFERENCES__FACE_DETECTION_HPP_
#define VINO_CORE_LIB__INFERENCES__FACE_DETECTION_HPP_
...
#include "vino_core_lib/engines/engine.hpp"
...
#endif  // VINO_CORE_LIB__INFERENCES__FACE_DETECTION_HPP_
