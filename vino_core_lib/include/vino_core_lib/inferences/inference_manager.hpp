 ...
 */
#ifndef VINO_CORE_LIB__INFERENCES__INFERENCE_MANAGER_HPP_
#define VINO_CORE_LIB__INFERENCES__INFERENCE_MANAGER_HPP_
...
#endif  // VINO_CORE_LIB__INFERENCES__INFERENCE_MANAGER_HPP_
