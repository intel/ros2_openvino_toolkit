 ...
 */
#ifndef VINO_CORE_LIB__INFERENCES__BASE_REIDENTIFICATION_HPP_
#define VINO_CORE_LIB__INFERENCES__BASE_REIDENTIFICATION_HPP_
#include <vector>
#include <cmath>
#include <string>
#include <thread>
...
#endif  // VINO_CORE_LIB__INFERENCES__BASE_REIDENTIFICATION_HPP_
