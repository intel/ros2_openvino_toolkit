 ...
 */
#ifndef VINO_CORE_LIB__INFERENCES__OBJECT_SEGMENTATION_HPP_
#define VINO_CORE_LIB__INFERENCES__OBJECT_SEGMENTATION_HPP_
...
#endif  // VINO_CORE_LIB__INFERENCES__OBJECT_SEGMENTATION_HPP_
