...
#ifndef VINO_CORE_LIB__INPUTS__REALSENSE_CAMERA_TOPIC_HPP_
#define VINO_CORE_LIB__INPUTS__REALSENSE_CAMERA_TOPIC_HPP_

#include "vino_core_lib/inputs/image_topic.hpp"
...
#endif  // VINO_CORE_LIB__INPUTS__REALSENSE_CAMERA_TOPIC_HPP_
