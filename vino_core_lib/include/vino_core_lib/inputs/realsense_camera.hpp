...
#ifndef VINO_CORE_LIB__INPUTS__REALSENSE_CAMERA_HPP_
#define VINO_CORE_LIB__INPUTS__REALSENSE_CAMERA_HPP_
...
#endif  // VINO_CORE_LIB__INPUTS__REALSENSE_CAMERA_HPP_
