...
#ifndef VINO_CORE_LIB__OUTPUTS__BASE_OUTPUT_HPP_
#define VINO_CORE_LIB__OUTPUTS__BASE_OUTPUT_HPP_

#include <object_msgs/msg/object_in_box.hpp>
#include <object_msgs/msg/objects_in_boxes.hpp>
#include <vino_people_msgs/msg/emotion.hpp>
#include <vino_people_msgs/msg/emotions_stamped.hpp>
#include <vino_people_msgs/msg/age_gender.hpp>
#include <vino_people_msgs/msg/age_gender_stamped.hpp>
#include <vino_people_msgs/msg/head_pose.hpp>
#include <vino_people_msgs/msg/head_pose_stamped.hpp>
#include <vino_people_msgs/srv/age_gender_srv.hpp>
#include <vino_people_msgs/srv/emotion_srv.hpp>
#include <vino_people_msgs/srv/people.hpp>
#include <vino_people_msgs/srv/head_pose_srv.hpp>
...
#include "vino_core_lib/inferences/object_detection.hpp"
...
public:
  ...
  virtual void setServiceResponseForFace(
    std::shared_ptr<object_msgs::srv::DetectObject::Response> response) {}
  virtual void setServiceResponse(
    std::shared_ptr<vino_people_msgs::srv::AgeGenderSrv::Response> response) {}
  virtual void setServiceResponse(
    std::shared_ptr<vino_people_msgs::srv::EmotionSrv::Response> response) {}
  virtual void setServiceResponse(
    std::shared_ptr<vino_people_msgs::srv::HeadPoseSrv::Response> response) {}
  virtual void setServiceResponse(
    std::shared_ptr<vino_people_msgs::srv::People::Response> response) {}
...
#endif  // VINO_CORE_LIB__OUTPUTS__BASE_OUTPUT_HPP_
