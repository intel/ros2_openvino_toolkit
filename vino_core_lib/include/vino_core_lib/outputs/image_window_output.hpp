...
#ifndef VINO_CORE_LIB__OUTPUTS__IMAGE_WINDOW_OUTPUT_HPP_
#define VINO_CORE_LIB__OUTPUTS__IMAGE_WINDOW_OUTPUT_HPP_
...
public:
   ...
   */
  void accept(
    const std::vector<vino_core_lib::LicensePlateDetectionResult> &) override;
  /**
   * @brief Generate image window output content according to
   ...
   */
  void accept(
    const std::vector<vino_core_lib::VehicleAttribsDetectionResult> &) override;
  /**
   * @brief Generate image window output content according to
   ...
   */
  void accept(
    const std::vector<vino_core_lib::FaceReidentificationResult> &) override;
  /**
   * @brief Generate image window output content according to
   ...
   */
  void accept(
    const std::vector<vino_core_lib::LandmarksDetectionResult> &) override;
  /**
   * @brief Generate image window output content according to
   ...
   */
  void accept(
    const std::vector<vino_core_lib::PersonAttribsDetectionResult> &) override;
  /**
   * @brief Generate image window output content according to
   ...
   */
  void accept(
    const std::vector<vino_core_lib::PersonReidentificationResult> &) override;
  /**
   * @brief Generate image window output content according to
...
#endif  // VINO_CORE_LIB__OUTPUTS__IMAGE_WINDOW_OUTPUT_HPP_
