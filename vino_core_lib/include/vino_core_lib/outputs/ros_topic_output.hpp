...
#ifndef VINO_CORE_LIB__OUTPUTS__ROS_TOPIC_OUTPUT_HPP_
#define VINO_CORE_LIB__OUTPUTS__ROS_TOPIC_OUTPUT_HPP_
...
#include <vino_people_msgs/msg/object_in_mask.hpp>
...
#include <vino_people_msgs/msg/person_attribute.hpp>
#include <vino_people_msgs/msg/person_attribute_stamped.hpp>
...
protected:
  ...
  rclcpp::Publisher<vino_people_msgs::msg::LicensePlateStamped>::SharedPtr pub_license_plate_;
  std::shared_ptr<vino_people_msgs::msg::LicensePlateStamped> license_plate_topic_;
  rclcpp::Publisher<vino_people_msgs::msg::VehicleAttribsStamped>::SharedPtr pub_vehicle_attribs_;
  std::shared_ptr<vino_people_msgs::msg::VehicleAttribsStamped> vehicle_attribs_topic_;
  rclcpp::Publisher<vino_people_msgs::msg::LandmarkStamped>::SharedPtr pub_landmarks_;
  std::shared_ptr<vino_people_msgs::msg::LandmarkStamped> landmarks_topic_;
  rclcpp::Publisher<vino_people_msgs::msg::ReidentificationStamped>::SharedPtr pub_face_reid_;
  std::shared_ptr<vino_people_msgs::msg::ReidentificationStamped> face_reid_topic_;
  rclcpp::Publisher<vino_people_msgs::msg::PersonAttributeStamped>::SharedPtr pub_person_attribs_;
  std::shared_ptr<vino_people_msgs::msg::PersonAttributeStamped> person_attribs_topic_;
  rclcpp::Publisher<vino_people_msgs::msg::ReidentificationStamped>::SharedPtr pub_person_reid_;
  std::shared_ptr<vino_people_msgs::msg::ReidentificationStamped> person_reid_topic_;
  rclcpp::Publisher<vino_people_msgs::msg::ObjectsInMasks>::SharedPtr pub_segmented_object_;
  std::shared_ptr<vino_people_msgs::msg::ObjectsInMasks> segmented_objects_topic_;
  ...
  rclcpp::Publisher<vino_people_msgs::msg::EmotionsStamped>::SharedPtr pub_emotion_;
  std::shared_ptr<vino_people_msgs::msg::EmotionsStamped> emotions_topic_;
  rclcpp::Publisher<vino_people_msgs::msg::AgeGenderStamped>::SharedPtr pub_age_gender_;
  std::shared_ptr<vino_people_msgs::msg::AgeGenderStamped> age_gender_topic_;
  rclcpp::Publisher<vino_people_msgs::msg::HeadPoseStamped>::SharedPtr pub_headpose_;
  std::shared_ptr<vino_people_msgs::msg::HeadPoseStamped> headpose_topic_;
};
}  // namespace Outputs
#endif  // VINO_CORE_LIB__OUTPUTS__ROS_TOPIC_OUTPUT_HPP_
