...
#ifndef VINO_CORE_LIB__MODELS__AGE_GENDER_DETECTION_MODEL_HPP_
#define VINO_CORE_LIB__MODELS__AGE_GENDER_DETECTION_MODEL_HPP_
...
#endif  // VINO_CORE_LIB__MODELS__AGE_GENDER_DETECTION_MODEL_HPP_
