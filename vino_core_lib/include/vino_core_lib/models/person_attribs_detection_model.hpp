 ...
 */
#ifndef VINO_CORE_LIB__MODELS__PERSON_ATTRIBS_DETECTION_MODEL_HPP_
#define VINO_CORE_LIB__MODELS__PERSON_ATTRIBS_DETECTION_MODEL_HPP_
#include <string>
...
#endif  // VINO_CORE_LIB__MODELS__PERSON_ATTRIBS_DETECTION_MODEL_HPP_
