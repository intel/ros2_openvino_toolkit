 ...
 */
#ifndef VINO_CORE_LIB__MODELS__FACE_REIDENTIFICATION_MODEL_HPP_
#define VINO_CORE_LIB__MODELS__FACE_REIDENTIFICATION_MODEL_HPP_
#include <string>
...
#endif  // VINO_CORE_LIB__MODELS__FACE_REIDENTIFICATION_MODEL_HPP_
