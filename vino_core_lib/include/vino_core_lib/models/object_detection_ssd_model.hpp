 ...
 */
#ifndef VINO_CORE_LIB__MODELS__OBJECT_DETECTION_SSD_MODEL_HPP_
#define VINO_CORE_LIB__MODELS__OBJECT_DETECTION_SSD_MODEL_HPP_
#include <string>
#include <memory>
#include <vector>
...
#endif  // VINO_CORE_LIB__MODELS__OBJECT_DETECTION_SSD_MODEL_HPP_
