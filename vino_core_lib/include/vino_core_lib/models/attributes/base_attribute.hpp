...
#ifndef VINO_CORE_LIB__MODELS__ATTRIBUTES_BASE_ATTRIBUTE_HPP_
#define VINO_CORE_LIB__MODELS__ATTRIBUTES_BASE_ATTRIBUTE_HPP_
...
#endif  // VINO_CORE_LIB__MODELS__ATTRIBUTES_BASE_ATTRIBUTE_HPP_
