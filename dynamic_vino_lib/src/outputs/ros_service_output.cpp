...
void Outputs::RosServiceOutput::feedFrame(const cv::Mat& frame) {frame_ = frame.clone();}
...
void Outputs::RosServiceOutput::setResponse(std::shared_ptr<object_msgs::srv::DetectObject::Response> response) {
