 ...
 */
#ifndef DYNAMIC_VINO_LIB__MODELS__FACE_REIDENTIFICATION_MODEL_HPP_
#define DYNAMIC_VINO_LIB__MODELS__FACE_REIDENTIFICATION_MODEL_HPP_
#include <string>
...
{
public:
  FaceReidentificationModel(const std::string &, int, int, int);
