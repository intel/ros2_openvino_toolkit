 ...
 */
#ifndef DYNAMIC_VINO_LIB_INFERENCES_OBJECT_DETECTION_YOLOV2_HPP_
#define DYNAMIC_VINO_LIB_INFERENCES_OBJECT_DETECTION_YOLOV2_HPP_
...
/**
 * @class ObjectDetectionYolov2voc
 * @brief Class to load face detection model and perform face detection.
 */
class ObjectDetectionYolov2 : public ObjectDetection {
 public:
  using Result = dynamic_vino_lib::ObjectDetectionResult;
  explicit ObjectDetectionYolov2(double);
  ~ObjectDetectionYolov2() override;
  /**
 ...
 private:
  std::shared_ptr<Models::ObjectDetectionYolov2Model> valid_model_;
  std::vector<Result> raw_results_;
  ...
  double IntersectionOverUnion(const Result &box_1, const Result &box_2);
  //int enqueued_frames_ = 0;
  int max_batch_size_ = 1;
  cv::Rect ROI_;
};
}  // namespace dynamic_vino_lib
#endif  // DYNAMIC_VINO_LIB__INFERENCES__OBJECT_DETECTION_YOLOV2_HPP_
