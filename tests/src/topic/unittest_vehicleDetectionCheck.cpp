...
TEST(UnitTestPersonReidentification, testReidentification)
{
  ...
  auto openvino_vehicle_callback =
    [&sub_called](const openvino_people_msgs::msg::LicensePlateStamped::SharedPtr msg) -> void {
      test_pass = true;
  ...
  {
    auto sub1 = node->create_subscription<openvino_people_msgs::msg::LicensePlateStamped>(
