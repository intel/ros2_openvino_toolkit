...
#include <vino_people_msgs/msg/persons_stamped.hpp>
...
#include "vino_core_lib/services/frame_processing_server.hpp"
...
int main(int argc, char ** argv)
{
  ...
  if (argc != 2) {
    RCLCPP_INFO(node->get_logger(), "Usage: ros2 run vino_sample image_object_client"
      "<image_path>");
    return -1;
  }
  ...
  auto client = node->create_client<vino_people_msgs::srv::People>("/openvino_toolkit/service");
  auto request = std::make_shared<vino_people_msgs::srv::People::Request>();
