 ...
 * @file video_input.h
 */
#ifndef OPENVINO_WRAPPER_LIB__INPUTS__VIDEO_INPUT_HPP_
#define OPENVINO_WRAPPER_LIB__INPUTS__VIDEO_INPUT_HPP_
...
public:
   ...
   */
  bool initialize(const std::string &video) override {video_.assign(video); return initialize();};
  /**
...
#endif  // OPENVINO_WRAPPER_LIB__INPUTS__VIDEO_INPUT_HPP_
