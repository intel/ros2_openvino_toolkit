 ...
 * @brief This class handles and publishes the detection result with ros topic.
 */
...
public:
  ...
  /**
   * @brief Publish all the detected information generated by the accept
   * functions with ros topic.
   */
  void handleOutput() override;
  /**
   * @brief Generate ros topic information according to
   ...
   * @param[in] An head pose detection result object.
   */
