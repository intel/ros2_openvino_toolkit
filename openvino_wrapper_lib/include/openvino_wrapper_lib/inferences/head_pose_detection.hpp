 ...
 */
#ifndef OPENVINO_WRAPPER_LIB__INFERENCES__HEAD_POSE_DETECTION_HPP_
#define OPENVINO_WRAPPER_LIB__INFERENCES__HEAD_POSE_DETECTION_HPP_
...
#endif  // OPENVINO_WRAPPER_LIB__INFERENCES__HEAD_POSE_DETECTION_HPP_
