 ...
 */
#ifndef OPENVINO_WRAPPER_LIB__INFERENCES__VEHICLE_ATTRIBS_DETECTION_HPP_
...
private:
  ...
  const std::vector<std::string> types_ = { "car", "van", "truck", "bus" };
  const std::vector<std::string> colors_ = { "white", "gray", "yellow", "red", "green", "blue", "black" };
};
}  // namespace openvino_wrapper_lib
#endif  // OPENVINO_WRAPPER_LIB__INFERENCES__VEHICLE_ATTRIBS_DETECTION_HPP_
