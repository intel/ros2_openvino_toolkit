...
Outputs::RvizOutput::RvizOutput(std::string output_name, const rclcpp::Node::SharedPtr node) : BaseOutput(output_name)
{
  if (node != nullptr) {
    node_ = node;
  } else {
...
void Outputs::RvizOutput::accept(const std::vector<openvino_wrapper_lib::FaceReidentificationResult>& results)
{
  image_window_output_->accept(results);
}

void Outputs::RvizOutput::accept(const std::vector<openvino_wrapper_lib::LandmarksDetectionResult>& results)
{
  image_window_output_->accept(results);
}

void Outputs::RvizOutput::accept(const std::vector<openvino_wrapper_lib::PersonAttribsDetectionResult>& results)
{
  image_window_output_->accept(results);
}

void Outputs::RvizOutput::accept(const std::vector<openvino_wrapper_lib::PersonReidentificationResult>& results)
{
  image_window_output_->accept(results);
}
...
void Outputs::RvizOutput::accept(const std::vector<openvino_wrapper_lib::ObjectDetectionResult>& results)
{
  image_window_output_->accept(results);
}

void Outputs::RvizOutput::accept(const std::vector<openvino_wrapper_lib::ObjectSegmentationResult>& results)
{
  image_window_output_->accept(results);
}

void Outputs::RvizOutput::accept(const std::vector<openvino_wrapper_lib::ObjectSegmentationMaskrcnnResult>& results)
{
  image_window_output_->accept(results);
}

void Outputs::RvizOutput::accept(const std::vector<openvino_wrapper_lib::ObjectSegmentationInstanceResult>& results)
{
  image_window_output_->accept(results);
}
...
void Outputs::RvizOutput::handleOutput()
{
  ...
  std_msgs::msg::Header header = getPipeline()->getInputDevice()->getLockedHeader();
