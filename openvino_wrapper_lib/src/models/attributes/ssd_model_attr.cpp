...
Models::SSDModelAttr::SSDModelAttr(const std::string model_name) : ModelAttribute(model_name)
{
}

bool Models::SSDModelAttr::updateLayerProperty(const std::shared_ptr<ov::Model>& model)
{
