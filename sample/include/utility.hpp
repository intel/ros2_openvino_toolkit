...
static const char face_detection_model_message[] = "Required. Path to an .xml file with a trained "
  "face detection model.";
static const char age_gender_model_message[] = "Optional. Path to an .xml file with a trained age "
  "gender model.";
static const char head_pose_model_message[] = "Optional. Path to an .xml file with a trained head "
  "pose model.";
static const char emotions_model_message[] = "Optional. Path to an .xml file with a trained "
  "emotions model.";
