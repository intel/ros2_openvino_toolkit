...
"""
ROS 2 Launch File: Object Detection Pipeline with Optional Visualization

Launches the OpenVINO object detection pipeline with optional visualization support.

Visualization options:
- viewer:=rviz2  -> Launches RViz2 with custom config
- viewer:=rqt    -> Launches rqt_image_view in standalone mode
- viewer:=none   -> No visualization (default)

Topics published:
- /ros2_openvino_toolkit/detected_objects: Detected objects
- /ros2_openvino_toolkit/image_rviz: Annotated image stream
"""
...
def generate_launch_description():
    ...
    resolved_yaml = launch_helpers.resolve_yaml_paths('pipeline_object.yaml')
