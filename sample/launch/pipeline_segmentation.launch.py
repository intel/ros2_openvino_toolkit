...
"""
ROS 2 Launch File: Object Segmentation Pipeline with RViz2

Launches the OpenVINO semantic segmentation pipeline with RViz2 visualization.
Performs pixel-wise classification of objects in the scene.
...
def generate_launch_description():
    """Generate launch description for semantic segmentation with RViz2."""

    # Get package share directory
    package_share_dir = get_package_share_directory('openvino_node')

    # Resolve YAML configuration paths
    resolved_yaml = launch_helpers.resolve_yaml_paths('pipeline_segmentation.yaml')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='Path to YAML configuration file for the OpenVINO segmentation pipeline'
        ),
