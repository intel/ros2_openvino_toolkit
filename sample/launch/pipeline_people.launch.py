...
"""
ROS 2 Launch File: People Analytics Pipeline with RViz2

Launches the OpenVINO people detection pipeline with multiple analytics:
- Face detection
...
def generate_launch_description():
    """Generate launch description for people analytics pipeline with RViz2."""

    # Get package share directory
    package_share_dir = get_package_share_directory('openvino_node')

    # Resolve YAML configuration paths
    resolved_yaml = launch_helpers.resolve_yaml_paths('pipeline_people.yaml')

    # RViz configuration for people visualization
    people_rviz = os.path.join(package_share_dir, 'launch', 'rviz', 'people.rviz')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='Path to YAML configuration file for the OpenVINO people pipeline'
        ),
        ...
        # OpenVINO people analytics node
        Node(
