...
"""
ROS 2 Launch File: YOLO Object Detection Pipeline with RViz2 (Topic-based)

Launches the OpenVINO YOLO-based object detection pipeline with RViz2 visualization.
Subscribes to camera image topics (e.g., from RealSense camera).

Supports YOLOv5, YOLOv7, YOLOv8 models converted to OpenVINO IR format.
...
Note: Launch your camera node separately before running this pipeline.
