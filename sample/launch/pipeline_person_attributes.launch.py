...
"""
ROS 2 Launch File: Person Attributes Detection Pipeline

Launches the OpenVINO person attributes detection pipeline with RViz2 visualization.
Detects persons and recognizes attributes such as clothing color, style,
accessories, etc.
...
def generate_launch_description():
    """Generate launch description for person attributes detection with RViz2."""

    # Get package share directory
    package_share_dir = get_package_share_directory('openvino_node')

    # Resolve YAML configuration paths
    resolved_yaml = launch_helpers.resolve_yaml_paths('pipeline_person_attributes.yaml')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='Path to YAML configuration file for the person attributes pipeline'
        ),
        ...
        # OpenVINO person attributes detection node
        Node(
            ...
            remappings=[
                ('/openvino_toolkit/object/detected_objects',
                 '/ros2_openvino_toolkit/detected_objects'),
                ('/openvino_toolkit/object/person_attributes',
                 '/ros2_openvino_toolkit/person_attributes'),
