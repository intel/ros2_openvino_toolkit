...
"""
ROS 2 Launch File: Person Re-identification Pipeline

Launches the OpenVINO person re-identification pipeline with RViz2 visualization.
Detects persons and assigns unique IDs to track the same person across frames.
...
def generate_launch_description():
    """Generate launch description for person re-identification with RViz2."""

    # Get package share directory
    package_share_dir = get_package_share_directory('openvino_node')

    # Resolve YAML configuration paths
    resolved_yaml = launch_helpers.resolve_yaml_paths('pipeline_reidentification.yaml')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='Path to YAML configuration file for the OpenVINO re-identification pipeline'
        ),
        ...
        # OpenVINO person re-identification node
        Node(
