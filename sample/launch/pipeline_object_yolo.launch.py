...
"""
ROS 2 Launch File: YOLO Object Detection Pipeline

Launches the OpenVINO YOLO-based object detection pipeline with RViz2 visualization.
Supports various YOLO models (YOLOv5, YOLOv7, YOLOv8) converted to OpenVINO IR format.
...
Note: Ensure your YOLO model is properly converted to OpenVINO format.
      See tutorials in doc/quick_start/ for conversion instructions.
"""
...
def generate_launch_description():
    ...
    resolved_yaml = launch_helpers.resolve_yaml_paths('pipeline_object_yolo.yaml')
